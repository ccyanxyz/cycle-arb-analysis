...
func ExportReceipts(blockchain *core.BlockChain, fn string) error {
...
func ExportAppendReceipts(blockchain *core.BlockChain, fn string, first uint64, last uint64) error {
	log.Info("Exporting receipts", "file", fn)
